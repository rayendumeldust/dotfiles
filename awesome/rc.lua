...
-- volumebarwidget:set_width(8)
-- volumebarwidget:set_height(10)
-- volumebarwidget:set_vertical(true)
-- volumebarwidget:set_background_color("#494B4F")
-- volumebarwidget:set_border_color(nil)
-- volumebarwidget:set_color("#AECF96")
-- volumebarwidget:set_gradient_colors({ "#AECF96", "#88A175", "#FF5656" })
-- vicious.register(volumebarwidget, vicious.widgets.volume,
...
--    awful.key({ modkey },          "l",   function ()  awful.util.spawn_with_shell("slock",nil) end),
